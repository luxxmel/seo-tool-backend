...
public class WebsiteAuditService {
    ...
    private void applyExternalSeoPlaceholders(AuditResponse response) {
        ...
        backlink.setNote("Chưa kết nối API backlink. Muốn lấy backlink/ref.domain thật thì cần API như Ahrefs, Semrush, Moz, Majestic hoặc DataForSEO.");
        ...
        organic.setNote("Chưa kết nối Google Search Console hoặc API SEO ngoài để lấy organic keyword/traffic thật.");
        ...
        paid.setNote("Chưa kết nối API paid search nên dữ liệu quảng cáo đang để N/A.");
        ...
        searchConsole.setNote("Chưa kết nối Google Search Console API để lấy click, impression, CTR và vị trí trung bình thật.");
